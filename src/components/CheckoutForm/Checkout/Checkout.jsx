    ...
    let Confirmation = () => (order.customer ? (
        <>
            <div>
                ...
                <Typography variatn="subtitle2">Order ref: {order.customer_reference}</Typography>
            </div>
            <br/>
        ...
        <CssBaseline/>
          ...
          <main className={classes.layout}>
              <Paper className = {classes.paper}>
                    ...
                    {/* if we map through and we are at then end of steps, so we've gone through payment and shipping details then go to confirmation page */}
